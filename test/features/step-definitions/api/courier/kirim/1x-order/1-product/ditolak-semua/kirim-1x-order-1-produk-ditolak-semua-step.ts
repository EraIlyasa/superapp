...
When('api courier user kirim 1x order 1 product ditolak semua super', async function () {

    console.log('api courier user kirim 1x order 1 product ditolak semua super')
...
When('api courier user kirim 1x order 1 product ditolak semua customer', async function () {

    console.log('api courier user kirim 1x order 1 product ditolak semua customer')
...
When('api courier user kirim 1x order 1 product ditolak semua customer e2e tolakan vendor', async function () {
